        ...
        <div>
            <form>
                ...
                <div className='flex justify-between'>
                    ...
                    <div>
                        <a className='text-[#0255A0]' href="">Forgot your password?</a>
                    </div>
                </div>
                ...
                <div className='text-center'>
                    <button className='px-3 py-2 bg-[#774e88] text-white' type='submit'>Login</button>
                </div>
                <div className="divider">OR</div>
                {/* social icon */}
                <div className='flex justify-center gap-2'>
                    <div className='text-center rounded-full text-xl w-16 py-4 mb-4  bg-white shadow-2xl cursor-pointer'>
                        <i class="fa-brands fa-facebook-f text-[#0866ff]"></i>
                    </div>
                    <div className='text-center rounded-full text-xl w-16 py-4 mb-4  bg-white shadow-2xl text-[#66b2fa] cursor-pointer'>
